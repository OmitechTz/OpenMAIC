...
│   ├── api/                    #   Server API routes (26 endpoint groups)
...
│   ├── @openmaic/              #   OpenMAIC SDK family (published to npm)
│   │   ├── dsl/                #     Course DSL definition & asset manifest
│   │   ├── generation/         #     Two-stage lesson generation pipeline
│   │   ├── renderer/           #     Course rendering
│   │   ├── importer/           #     Classroom import
│   │   ├── editor/             #     Slide editing
│   │   └── storage/            #     Runtime/Document/asset storage layer (Postgres, S3, …)
