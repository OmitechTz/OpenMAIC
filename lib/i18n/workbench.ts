...
export const workbenchEn = {
  ...
  skill: {
    ...
    title: {
      ...
      'omitech-differentiated-learning': 'Omitech differentiated learning',
      'omitech-document-to-course': 'Omitech document to course',
      'omitech-knowledge-assessment': 'Omitech knowledge assessment',
      'omitech-lab-learning': 'Omitech lab learning',
      'omitech-lecture-builder': 'Omitech lecture builder',
      'omitech-lesson-planner': 'Omitech lesson planner',
      'omitech-student-onboarding': 'Omitech student onboarding',
...
export const workbenchZh = {
  ...
  skill: {
    ...
    title: {
      ...
      'lecture-style': '大师讲授',
      'omitech-differentiated-learning': 'Omitech 差异化学习',
      'omitech-document-to-course': 'Omitech 文档转课程',
      'omitech-knowledge-assessment': 'Omitech 知识评估',
      'omitech-lab-learning': 'Omitech 实验学习',
      'omitech-lecture-builder': 'Omitech 讲座构建',
      'omitech-lesson-planner': 'Omitech 课程规划',
      'omitech-student-onboarding': 'Omitech 学生入门',
      'page-clone': '页面克隆',
      'pptx-import': 'PPT 导入',
      'pro-editing': '专业编辑',
      'slide-craft': '页面设计',
