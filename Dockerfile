...
ARG NEXT_PUBLIC_OMITECH_INTEGRATION
ARG NEXT_PUBLIC_OMITECH_PARENT_ORIGINS
ARG NEXT_PUBLIC_OMITECH_AGENT_URL
...
ENV NEXT_PUBLIC_OMITECH_INTEGRATION=$NEXT_PUBLIC_OMITECH_INTEGRATION
ENV NEXT_PUBLIC_OMITECH_PARENT_ORIGINS=$NEXT_PUBLIC_OMITECH_PARENT_ORIGINS
ENV NEXT_PUBLIC_OMITECH_AGENT_URL=$NEXT_PUBLIC_OMITECH_AGENT_URL
